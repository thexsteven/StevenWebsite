...
export default function Home() {
  return <div className="society-home dark">
    ...
    <section className="society-travels" data-sc-act="flow">
      ...
      <article className="journey-panel venice-panel"><div className="panel-copy"><p className="meta">Venedig · 2026</p><h3>Durch die Dolomiten.<br />Bis in die Lagune.</h3><p>Ein langes Wochenende im Wohnmobil, von einer kalten Nacht in den Bergen bis zum Piano in einer Bar.</p><Link className="text-link" href="/reisen/venedig">Die Venedig-Reise lesen ↗</Link></div><Link className="panel-media" href="/reisen/venedig" aria-label="Die Venedig-Reise lesen"><TravelMedia caption={false} name="venice" /></Link></article>
