...
export default function Radtour() {
  return <>
    ...
    <section className="story-grid wrap" data-sc-act="flow"><TravelMedia name="cycling" /><nav className="chapter-nav" aria-label="Kapitel der Radtour"><h2>Die Strecke lesen</h2><a href="#aufbruch">Aufbruch <span>↗</span></a><a href="#alpen">Über die Berge <span>↗</span></a><a href="#turin">Turin <span>↗</span></a><a href="#kueche">Ein Abend in der Küche <span>↗</span></a><a href="#ankunft">Ankunft <span>↗</span></a></nav></section>
    <article className="prose">
      <section id="aufbruch"><h2>Vor der eigenen Tür.</h2><p>Im Sommer 2025 bin ich mit dem Rad über die Alpen bis nach Südfrankreich gefahren. Die Bildfolge beginnt an der Einfahrt zu Hause. Hier setzt auch die Geschichte an, bevor die Berge und die Orte unterwegs ihren Platz bekommen.</p><TravelMedia name="departure" /><OpenQuestion>Wie kam die Idee zu dieser Tour? Was ging dir beim Losfahren durch den Kopf, und mit wem warst du unterwegs, ohne Namen zu nennen?</OpenQuestion></section>
